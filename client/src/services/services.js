...
//emoji routes
const openEmojiApiKey = process.env.REACT_APP_OPENEMOJIAPIKEY;
...
console.log("api: ", process.env.REACT_APP_OPENEMOJIAPIKEY);
//giphy toutes
const giphyApiKey = process.env.REACT_APP_GIPHY_API_KEY_HERE;
